...
class Infraction(commands.Cog):
    ...
    async def update(self, interaction: discord.Interaction, user: discord.User, infraction: int, update: str):
...
async def setup(bot):
    await bot.add_cog(Infraction(bot), guilds=[discord.Object(id=bot.guild_id)])