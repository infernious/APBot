...
class Arts(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        custom_id="Studio Art 2D",
        emoji="<:2DArt:614310804761608207>",
        row=0,
    )
    ...
    @discord.ui.button(
        label="Studio Art 3D",
        style=discord.ButtonStyle.grey,
        custom_id="Studio Art 3D",
        emoji="<:3DArt:1061485699972464670>",
        row=1,
    )
    ...
    @discord.ui.button(
        label="Drawing", style=discord.ButtonStyle.grey, custom_id="Drawing", emoji="<:Drawing:1061486284234821743>", row=2
    )
    ...
    @discord.ui.button(
        label="Art History",
        style=discord.ButtonStyle.grey,
        custom_id="Art History",
        emoji="<:ArtHistory:1061485761960087552>",
        row=0,
    )
    ...
    @discord.ui.button(
        ...
        emoji="<:MusicTheory:1061486683201208511>",
        row=1,
    )
...
class English(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        emoji="<:EnglishLiterature:1061486349015851038>",
        row=0,
    )
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="Language",
        emoji="<:EnglishLanguage:1061486335245951086>",
        row=1,
    )
    ...
    @discord.ui.button(
        label="Seminar", style=discord.ButtonStyle.grey, custom_id="Seminar", emoji="<:Seminar:1061486772825100429>", row=0
    )
    ...
    @discord.ui.button(
        label="Research", style=discord.ButtonStyle.grey, custom_id="Research", emoji="<:Research:1061486754646990898>", row=1
    )
...
class Languages(discord.ui.View):
    ...
    @discord.ui.button(
        label="Japanese", style=discord.ButtonStyle.grey, custom_id="Japanese", emoji="<:Japanese:1061486555199447040>", row=0
    )
    ...
    @discord.ui.button(
        label="Italian", style=discord.ButtonStyle.grey, custom_id="Italian", emoji="<:Italian:1061486542369075200>", row=0
    )
    ...
    @discord.ui.button(
        label="Chinese", style=discord.ButtonStyle.grey, custom_id="Chinese", emoji="<:Chinese:1061486236109394020>", row=0
    )
    ...
    @discord.ui.button(
        label="Latin", style=discord.ButtonStyle.grey, custom_id="Latin", emoji="<:Latin:1061486569162280990>", row=1
    )
    ...
    @discord.ui.button(
        label="German", style=discord.ButtonStyle.grey, custom_id="German", emoji="<:German:1061486440904667186>", row=1
    )
    ...
    @discord.ui.button(
        label="French", style=discord.ButtonStyle.grey, custom_id="French", emoji="<:French:1061486415361347705>", row=1
    )
    ...
    @discord.ui.button(
        label="Spanish Lang",
        style=discord.ButtonStyle.grey,
        custom_id="Spanish Lang",
        emoji="<:SpanishLanguage:1061486827539795998>",
        row=2,
    )
    ...
    @discord.ui.button(
        label="Spanish Lit",
        style=discord.ButtonStyle.grey,
        custom_id="Spanish Lit",
        emoji="<:SpanishLiterature:1061486844807762000>",
        row=2,
    )
...
class MathCS(discord.ui.View):
    ...
    @discord.ui.button(
        label="Precalc", style=discord.ButtonStyle.grey, custom_id="Precalc", emoji="<:precalc:1061804037915279460>", row=0
    )
    ...
    @discord.ui.button(
        label="Calc AB", style=discord.ButtonStyle.grey, custom_id="Calc AB", emoji="<:CalculusAB:1061486117397995530>", row=1
    )
    ...
    @discord.ui.button(
        label="Calc BC", style=discord.ButtonStyle.grey, custom_id="Calc BC", emoji="<:CalculusBC:1061486180853616720>", row=2
    )
    ...
    @discord.ui.button(
        label="Stats", style=discord.ButtonStyle.grey, custom_id="Stats", emoji="<:Statistics:1061486861790482563>", row=0
    )
    ...
    @discord.ui.button(
        label="Comp Sci A", style=discord.ButtonStyle.grey, custom_id="Comp Sci A", emoji="<:CSA:1061485898895724615>", row=1
    )
    ...
    @discord.ui.button(
        label="Comp Sci Prin",
        style=discord.ButtonStyle.grey,
        custom_id="Comp Sci Prin",
        emoji="<:CSP:1061486067016015892>",
        row=2,
    )
...
class Sciences(discord.ui.View):
    ...
    @discord.ui.button(
        label="Physics 1", style=discord.ButtonStyle.grey, custom_id="Physics 1", emoji="<:Physics1:1061486700485955644>", row=0
    )
    ...
    @discord.ui.button(
        label="Physics 2", style=discord.ButtonStyle.grey, custom_id="Physics 2", emoji="<:Physics2:1061486719960096890>", row=1
    )
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="Chemistry",
        emoji="<:Chemistry:1061486200810131476>",
        row=2,
    )
    ...
    @discord.ui.button(
        label="Mech", style=discord.ButtonStyle.grey, custom_id="Mech", emoji="<:Mechanics:1061486622446731354>", row=0
    )
    ...
    @discord.ui.button(label="E/M", style=discord.ButtonStyle.grey, custom_id="E/M", emoji="<:EM:1061486300995268658>", row=1)
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="Enviro",
        emoji="<:EnvironmentalScience:1061486372541698099>",
        row=0,
    )
    ...
    @discord.ui.button(
        label="Biology", style=discord.ButtonStyle.grey, custom_id="Biology", emoji="<:Biology:1061485856868794368>", row=1
    )
...
class SocialStudies(discord.ui.View):
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="Comp Gov",
        emoji="<:ComparativeGovernment:1061486253192781865>",
        row=0,
    )
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="World M",
        emoji="<:ModernWorldHistory:1061486662284222525>",
        row=1,
    )
    ...
    @discord.ui.button(
        ...
        style=discord.ButtonStyle.grey,
        custom_id="Human Geo",
        emoji="<:HumanGeography:1061486512585314325>",
        row=2,
    )
    ...
    @discord.ui.button(
        label="US Gov", style=discord.ButtonStyle.grey, custom_id="US Gov", emoji="<:USGovernment:1061486879884722206>", row=0
    )
    ...
    @discord.ui.button(
        label="APUSH", style=discord.ButtonStyle.grey, custom_id="APUSH", emoji="<:USHistory:1061486902903054386>", row=1
    )
    ...
    @discord.ui.button(
        label="Micro", style=discord.ButtonStyle.grey, custom_id="Micro", emoji="<:Microeconomics:1061486644559089724>", row=2
    )
    ...
    @discord.ui.button(
        label="Psych", style=discord.ButtonStyle.grey, custom_id="Psych", emoji="<:Psychology:1061486737857183774>", row=0
    )
    ...
    @discord.ui.button(
        label="Euro", style=discord.ButtonStyle.grey, custom_id="Euro", emoji="<:EuropeanHistory:1061486395455180832>", row=1
    )
    ...
    @discord.ui.button(
        label="Macro", style=discord.ButtonStyle.grey, custom_id="Macro", emoji="<:Macroeconomics:1061486600267251732>", row=2
    )
...
class PostAP(discord.ui.View):
    ...
    @discord.ui.button(
        label="Higher CS", style=discord.ButtonStyle.grey, custom_id="Higher CS", emoji="<:highercs:1061801585312804924>"
    )
...
class Pronouns(discord.ui.View):
    ...
    @discord.ui.button(
        label="she/her", style=discord.ButtonStyle.grey, custom_id="she", emoji="<:sheher:1061486974055227492>", row=0
    )
    ...
    @discord.ui.button(
        label="he/him", style=discord.ButtonStyle.grey, custom_id="he", emoji="<:hehim:1061486951875760241>", row=1
    )
    ...
    @discord.ui.button(
        label="they/them", style=discord.ButtonStyle.grey, custom_id="they", emoji="<:theythem:1061486997576892416>", row=0
    )
    ...
    @discord.ui.button(
        label="Ask me!", style=discord.ButtonStyle.grey, custom_id="ask", emoji="<:askme:1061803381804507257>", row=1
    )
...
class LoungeOne(discord.ui.View):
    ...
    @discord.ui.button(label="Anime-Manga", style=discord.ButtonStyle.grey, custom_id="anime-manga", emoji="🍡", row=0)
    ...
    @discord.ui.button(label="Art", style=discord.ButtonStyle.grey, custom_id="art", emoji="🖌", row=1)
    ...
    @discord.ui.button(label="Books-Writing", style=discord.ButtonStyle.grey, custom_id="books-writing", emoji="📚", row=2)
    ...
    @discord.ui.button(label="Events", style=discord.ButtonStyle.grey, custom_id="events", emoji="🎉", row=0)
    ...
    @discord.ui.button(label="Fashion", style=discord.ButtonStyle.grey, custom_id="fashion", emoji="👓", row=1)
    ...
    @discord.ui.button(label="Film-TV", style=discord.ButtonStyle.grey, custom_id="film-tv", emoji="📽", row=2)
...
class LoungeTwo(discord.ui.View):
    ...
    @discord.ui.button(label="Food", style=discord.ButtonStyle.grey, custom_id="food", emoji="🥘", row=0)
    ...
    @discord.ui.button(label="Gaming", style=discord.ButtonStyle.grey, custom_id="gaming", emoji="🎮", row=1)
    ...
    @discord.ui.button(label="Languages", style=discord.ButtonStyle.grey, custom_id="languages", emoji="🌐", row=2)
    ...
    @discord.ui.button(label="Music", style=discord.ButtonStyle.grey, custom_id="music", emoji="🎵", row=0)
    ...
    @discord.ui.button(label="Pets", style=discord.ButtonStyle.grey, custom_id="pets", emoji="🐱", row=1)
    ...
    @discord.ui.button(label="Photography", style=discord.ButtonStyle.grey, custom_id="photography", emoji="📷", row=2)
...
class LoungeThree(discord.ui.View):
    ...
    @discord.ui.button(label="Sports", style=discord.ButtonStyle.grey, custom_id="sports", emoji="🏀", row=0)
    ...
    @discord.ui.button(label="Tech", style=discord.ButtonStyle.grey, custom_id="tech", emoji="🖥️", row=0)
